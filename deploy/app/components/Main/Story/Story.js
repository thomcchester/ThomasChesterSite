...
class Story extends React.Component {
  ...
  render() {
    ...
    return (
      <story>
        <div className="backgroundActual">
        <br></br>
        <br></br>
        <br></br>
        <div className="headActual">
        ...
        <div className="allText">
          ...
          <p className="storyTime"> I went to UC Boulder for a year. Not mature enough to handle that yet. Took some time off. Got lost for awhile. Had a rather interesting experience in France which lead me to Minnesota. Stayed there for a Month, then moved to Port Townsend, WA. Lived there for sixish months. Moved back to Minneapolis to attend Augsburg college. Studied Mathematics and Physics. Yes I am a nerd. Met wife. She rules. Decided way to close to the end of college that computer science was more me. Started programming a lot. Attended Prime Digital Academy. Started Programming more. Now as a new Dad, trying to make it as a developer. ps. I apologize for the poor design. Im not the best at that.</p>
          </div>
        </div>
      </story>
    );
